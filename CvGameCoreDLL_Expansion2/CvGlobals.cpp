...
// -- floats --
	...
	m_fTOURISM_COMBAT_MAX(50),
	m_fTOURISM_COMBAT_DIVISOR(2),
...
void CvGlobals::cacheGlobals()
{
	...
	m_fTOURISM_COMBAT_MAX = getDefineFLOAT("TOURISM_COMBAT_MAX");
	m_fTOURISM_COMBAT_DIVISOR = getDefineFLOAT("TOURISM_COMBAT_DIVISOR");
